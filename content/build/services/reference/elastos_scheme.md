...
Schemes and parameters are the sames for all programming environments (elastOS, native apps ...). Nevertheless, the way to call them and get response changes. Please refer to the {{< internallink "elastos scheme guide" "/build/services/guides/elastos_scheme.md" >}} for more information about your platform.
