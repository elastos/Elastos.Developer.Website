...
The Elastos CLI will connect to the default rpcport[20336] of the local ela node. If you modified a different rpcport and set the rpcuser and rpcpassword in config.json for ela node, you should add the parameters below in your command.

| Parameter     | Description                                                                           |
| ------------- | ------------------------------------------------------------------------------------- |
| --rpcport     | Specify the port number to which the RPC server is bound. The default value is 20336. |
...
| Command  | Description                                                                                              |
| -------- | -------------------------------------------------------------------------------------------------------- |
| --from   | Specify the transfer-out account address. The default value is the default account of the keystore file. |
| --to     | Specify the transfer-in account address.                                                                 |
| --tomany | Specify the file which contains multiple outputs.                                                        |
| --amount | Specify the transfer amount.                                                                             |
| --fee    | Specify the transfer fee.                                                                                |
